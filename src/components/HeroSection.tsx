...
const HeroSection = () => {
  return (
    // FIX 1: Added "py-20" to ensure top/bottom spacing on short screens
    // This allows the min-h-screen to grow properly without overlap
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-20">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-secondary/5 blur-3xl animate-pulse-glow"
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-32 right-[15%] opacity-20 animate-float"
          style={{ animationDelay: "1s" }}
        >
          <Bot className="w-10 h-10 text-secondary" />
        </div>
        <div
          className="absolute bottom-32 left-[20%] opacity-20 animate-float"
          style={{ animationDelay: "2s" }}
        >
          <Code className="w-14 h-14 text-primary" />
        </div>
        <div
          className="absolute bottom-40 right-[10%] opacity-20 animate-float"
      ...
      {/* FIX 2: Removed "top-5 bottom-8". Padding in parent handles this now. */}
      <div className="container relative z-10 px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          {/* Badge */}
          <div
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full tech-border text-sm text-muted-foreground animate-fade-in"
          ...
          {/* Main headline */}
          <h1
            className="font-display text-4xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in"
            style={{ animationDelay: "0.15s" }}
          >
            Hi, I'm <span className="text-gradient">Bunmi Oladipupo</span>
            <br />
      ...
      {/* Scroll indicator - kept absolute */}
